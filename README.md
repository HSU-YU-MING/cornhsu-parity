...
```yaml
- uses: HSU-YU-MING/cornhsu-parity@v0.11.0   # 0.x 期間 pin 版本;發 1.0 後可改用移動式 @v1
  with:
...
| | |
|---|---|
| 發佈 | NuGet 共 20 版(v0.1.0 → v0.11.0),推 tag 即以 OIDC Trusted Publishing 自動上架,repo 內零長效金鑰 |
...
| 真實驗證 | **cornhsu.com 全站 21 頁由 Parity 自己守門**——dogfooding 已揪出並修掉三個 flaky 根因(最新一個:捲動觸發的進場動畫,見 0.11.0) |
